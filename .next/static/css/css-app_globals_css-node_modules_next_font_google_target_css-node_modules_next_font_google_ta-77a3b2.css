...
[hidden]:where(:not([hidden="until-found"])) {
  ...
  :root {
    --primary: 220 90% 56%; /* #3c7bf6 in HSL */
    --primary-dark: 220 90% 45%;
    --primary-light: 220 90% 97%;
    --gradient-start: #3c7bf6;
    --gradient-end: #2563eb;
  }
...
.border-\[\#3c7bf6\]\/20 {
  border-color: rgb(60 123 246 / 0.2);
}
.border-blue-200 {
  --tw-border-opacity: 1;
...
.bg-\[\#3c7bf6\] {
  --tw-bg-opacity: 1;
  background-color: rgb(60 123 246 / var(--tw-bg-opacity, 1));
}
.bg-\[\#3c7bf6\]\/10 {
  background-color: rgb(60 123 246 / 0.1);
}
.bg-\[\#3c7bf6\]\/20 {
  background-color: rgb(60 123 246 / 0.2);
}
.bg-\[\#3c7bf6\]\/5 {
  background-color: rgb(60 123 246 / 0.05);
}
.bg-black {
  --tw-bg-opacity: 1;
...
.bg-\[\#3c7bf6\]\/30 {
  background-color: rgb(60 123 246 / 0.3);
}
.bg-\[\#3c7bf6\]\/40 {
  background-color: rgb(60 123 246 / 0.4);
}
.bg-black\/20 {
...
.from-\[\#00d4ff\]\/50 {
  --tw-gradient-from: rgb(0 212 255 / 0.5) var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(0 212 255 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.from-\[\#3c7bf6\] {
  --tw-gradient-from: #3c7bf6 var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(60 123 246 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.from-\[\#3c7bf6\]\/10 {
  --tw-gradient-from: rgb(60 123 246 / 0.1) var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(60 123 246 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.from-\[\#3c7bf6\]\/20 {
  --tw-gradient-from: rgb(60 123 246 / 0.2) var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(60 123 246 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.from-\[\#3c7bf6\]\/5 {
  --tw-gradient-from: rgb(60 123 246 / 0.05) var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(60 123 246 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.from-blue-400 {
...
.via-\[\#3c7bf6\]\/70 {
  --tw-gradient-to: rgb(60 123 246 / 0)  var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), rgb(60 123 246 / 0.7) var(--tw-gradient-via-position), var(--tw-gradient-to);
}
.via-transparent {
  --tw-gradient-to: rgb(0 0 0 / 0)  var(--tw-gradient-to-position);
...
.via-\[\#0a1929\] {
  --tw-gradient-to: rgb(10 25 41 / 0)  var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), #0a1929 var(--tw-gradient-via-position), var(--tw-gradient-to);
}
.to-\[\#2563eb\] {
...
.to-\[\#1a3a6b\]\/30 {
  --tw-gradient-to: rgb(26 58 107 / 0.3) var(--tw-gradient-to-position);
}
.to-\[\#1a3a6b\]\/50 {
  --tw-gradient-to: rgb(26 58 107 / 0.5) var(--tw-gradient-to-position);
}
.to-\[\#1a3a6b\]\/20 {
  --tw-gradient-to: rgb(26 58 107 / 0.2) var(--tw-gradient-to-position);
}
.to-\[\#1a3a6b\]\/40 {
  --tw-gradient-to: rgb(26 58 107 / 0.4) var(--tw-gradient-to-position);
}
.object-cover {
  -o-object-fit: cover;
     object-fit: cover;
...
.text-\[\#3c7bf6\] {
  --tw-text-opacity: 1;
  color: rgb(60 123 246 / var(--tw-text-opacity, 1));
}
.text-black {
  --tw-text-opacity: 1;
...
/* Premium shadows like Lumin */
.shadow-card {
    box-shadow: 0 1px 3px 0 rgb(0 0 0 / 0.02), 
                0 1px 10px -2px rgb(0 0 0 / 0.08);
  }
...
.hover\:border-\[\#3c7bf6\]\/30:hover {
  border-color: rgb(60 123 246 / 0.3);
}

.hover\:border-\[\#3c7bf6\]\/50:hover {
  border-color: rgb(60 123 246 / 0.5);
}
...
.hover\:bg-\[\#2a5fc4\]:hover {
  --tw-bg-opacity: 1;
  background-color: rgb(42 95 196 / var(--tw-bg-opacity, 1));
}
...
.group:hover .group-hover\:text-\[\#3c7bf6\] {
  --tw-text-opacity: 1;
  color: rgb(60 123 246 / var(--tw-text-opacity, 1));
}
